...
def render_generated_module(
    ...
    fetch_ts, utc_tai_sha = provenance["utc_tai"]
...
//
// Provenance (fetched {fetch_ts} UTC):
...
def main(argv: list[str]) -> int:
    ...
    rendered = render_generated_module(utc_tai_segments, modern_delta_t_points, provenance)
