...
#[inline]
pub(crate) fn jd_to_julian_centuries(jd: Days) -> f64 {
...
#[inline]
pub(crate) fn mjd_to_unix_seconds(mjd: Days) -> Seconds {
    (mjd - UNIX_EPOCH_MJD).to::<Second>()
}
...
mod tests {
    ...
    const EPS_D: Days = Days::new(1e-15);

    #[test]
    fn jd_j2000_round_trip() {
        let jd = Days::new(2_451_545.5);
    ...
    fn unix_mjd_round_trip() {
        let mjd = Days::new(40_587.0); // Unix epoch
