...
//
// Provenance (fetched 2025-07-10T00:00:00 UTC):
//   UTC-TAI history  SHA-256: (see scripts/update_time_data.py --check to verify)
//   ΔT observed      SHA-256: (see scripts/update_time_data.py --check to verify)
//   ΔT predictions   SHA-256: (see scripts/update_time_data.py --check to verify)
